...
namespace HumanAfterAll
{
    class WaterTile : Tile
    {
        ...
        public WaterTile(Texture2D _texture, Vector2 _position, ContentManager _content, World _world, Player _player)
        {
        ...
        public override bool Body_OnCollision(Fixture fixtureA, Fixture fixtureB, FarseerPhysics.Dynamics.Contacts.Contact contact)
        {
            ...
            {
                fixtureB.Body.ApplyForce(new Vector2(0, -0.2f));
                fixtureA.Body.ApplyForce(new Vector2(0, -0.2f));
            }
            else
            {
                fixtureB.Body.ApplyForce(new Vector2(0, -0.004f));
                fixtureA.Body.ApplyForce(new Vector2(0, -0.004f));
            }
