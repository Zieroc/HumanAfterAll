...
namespace HumanAfterAll
{
    class OilFiller : Tile
    {
        ...
        public OilFiller(Texture2D _texture, Vector2 _position, ContentManager _content, World _world, Player _player, ScreenManager _screenManager)
        {
        ...
        public override bool Body_OnCollision(Fixture fixtureA, Fixture fixtureB, FarseerPhysics.Dynamics.Contacts.Contact contact)
        {
            ...
            {
                Player._blood+=(100 - Player._blood) / 100;
            }
            return false;
        }
    }
